...
<html lang="en">
  <head>
    ...
    <title>Savvy SkillScape</title>
  </head>
  <body>
     <!-- Start Nagigation -->
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
        <a href="index.php" class="navbar-brand">Savvy SkillScape</a>
      <span class="navbar-text">Learn and Earn</span>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <li class="nav-item custom-nav-item"><a href="oppor.php" class="nav-link">Opportunities</a></li>
          <li class="nav-item custom-nav-item"><a href="graph.php" class="nav-link">Statistics</a></li>
          <li class="nav-item custom-nav-item"><a href="yearwise.php" class="nav-link">Year-wise data</a></li>
          <li class="nav-item custom-nav-item"><a href="rate.php" class="nav-link">Ratings</a></li>
